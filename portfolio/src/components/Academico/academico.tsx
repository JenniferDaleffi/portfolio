...
export default function Academico(){
    return(
        ...
        <div className="flex justify-center text-3xl pt-20 text-white">
            <h1 className="border-b w-56 text-center">Perfil Acadêmico</h1>
        </div>
        <div className="mt-20 mb-32 flex justify-center gap-48 text-white">
            <div className="w-1/4 border border-white rounded-lg hover:scale-110 hover:duration-300 mb-32">
